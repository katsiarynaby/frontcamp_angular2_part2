...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<h3>404</h3>\n");
...
let ApiService = class ApiService {
    ...
    getSources() {
        ...
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((obj => obj.sources)));
    }
    getArticles(id, page) {
        const url = baseUrl + `v2/top-headlines?sources=${id}&page=${page}&pageSize=5` + apiKey;
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(obj => obj.articles));
    }
};
...
/* harmony import */ var _main__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./main */ "./src/app/main/index.ts");
/* harmony import */ var _not_found__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./not-found */ "./src/app/not-found/index.ts");
/* harmony import */ var _news_form__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./news-form */ "./src/app/news-form/index.ts");
...
const routes = [
    { path: '', component: _main__WEBPACK_IMPORTED_MODULE_3__["MainComponent"] },
    { path: 'edit/:NewsID', component: _news_form__WEBPACK_IMPORTED_MODULE_5__["NewsFormComponent"] },
    { path: 'edit', component: _news_form__WEBPACK_IMPORTED_MODULE_5__["NewsFormComponent"] },
    { path: '404', component: _not_found__WEBPACK_IMPORTED_MODULE_4__["NotFoundComponent"] },
    { path: '**', redirectTo: '404' },
];
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "MainComponent", function() { return _main_component__WEBPACK_IMPORTED_MODULE_1__["MainComponent"]; });
...
let MainComponent = class MainComponent {
    ...
    ngOnInit() {
        ...
        this.text = '';
        this.apiService.getSources().subscribe(res => {
            this.sources = res;
    ...
    onChangeObj(selectedSource) {
        ...
        this.apiService.getArticles(this.sourceId, 1).subscribe(res => {
            if (res.length > 0) {
                this.articles = res;
                this.articlePage = 1;
                this.isAdded = true;
    ...
    loadMore() {
        this.articlePage++;
        this.apiService.getArticles(this.sourceId, this.articlePage).subscribe(res => {
            if (res.length > 0) {
...
], MainComponent.prototype, "isAdded", void 0);
...
class ArticleModel {
    constructor(id = '', urlToImage = '', url = '', title = '', description = '', publishedAt = '', createdByMe) {
        this.id = id;
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _news_form_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./news-form.component */ "./src/app/news-form/news-form.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "NewsFormComponent", function() { return _news_form_component__WEBPACK_IMPORTED_MODULE_1__["NewsFormComponent"]; });
...
/* harmony import */ var _pipes__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../pipes */ "./src/app/pipes/index.ts");
...
let NewsFormComponent = class NewsFormComponent {
    ...
    onSaveNews() {
        const Article = Object.assign({}, this.form.value);
        console.log(Article);
        this.onGoBack();
    }
    onGoBack() {
...
NewsFormComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./news-form.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/news-form/news-form.component.html")).default,
        providers: [_pipes__WEBPACK_IMPORTED_MODULE_5__["DatePipe"]],
        changeDetection: _angular_core__WEBPACK_IMPORTED_MODULE_2__["ChangeDetectionStrategy"].OnPush,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./news-form.component.scss */ "./src/app/news-form/news-form.component.scss")).default]
    })
], NewsFormComponent);
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "NotFoundComponent", function() { return _not_found_component__WEBPACK_IMPORTED_MODULE_1__["NotFoundComponent"]; });
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _date_pipe__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./date.pipe */ "./src/app/pipes/date.pipe.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "DatePipe", function() { return _date_pipe__WEBPACK_IMPORTED_MODULE_1__["DatePipe"]; });
...
module.exports = __webpack_require__(/*! /Users/katsiarynakananchuk/frontcamp_angular2_part2/src/main.ts */"./src/main.ts");
